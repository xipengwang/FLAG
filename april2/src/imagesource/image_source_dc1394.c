...
void image_source_dc1394_enumerate(zarray_t *urls)
{
    dc1394_t *dc1394;
    dc1394camera_list_t *list;
...
void image_source_dc1394_setup()
{
   struct image_source_provider *provider = calloc(1, sizeof(struct image_source_provider));
   provider->protocol = strdup("dc1394://");
   provider->open = image_source_dc1394_open;
   provider->enumerate = image_source_dc1394_enumerate;
