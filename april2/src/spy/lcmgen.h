...
struct lcm_struct
{
  ...
  zarray_t *members;  // lcm_member_t

  // recursive declaration of structs and enums
  zarray_t *enums;    // locally-declared enums  DEPRECATED
  zarray_t *constants; // lcm_constant_t
...
struct lcm_enum
{
	...
	zarray_t *values;   // legal values for the enum
	char *lcmfile;      // file/path of function that declared it
...
struct lcmgen
{
    ...
    getopt_t  *gopt;
    zarray_t *structs; // lcm_struct_t
    zarray_t *enums;   // lcm_enum_t (declared at top level)
